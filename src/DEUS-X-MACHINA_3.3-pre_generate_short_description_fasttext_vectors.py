...
from util.config import API_SHORT_DESCRIPTION_FASTTEXT_VECTOR_STORE_PATH, JAVADOC_GLOBAL_NAME, APIDOC_WIKI_FASTTEXT_MODEL_STORE_PATH
...
def pre_generate_short_description_fasttext_vectors(doc_name: str = JAVADOC_GLOBAL_NAME):
    ...
    vector_util = VectorUtil(APIDOC_WIKI_FASTTEXT_MODEL_STORE_PATH[doc_name])
